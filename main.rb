...
phone = StoreFront::Item.new(model: "iPhone XR", color: "space grey", price: 800)
...
cupcake = StoreFront::Food.new(model: "Cupcake", color: "chocolate", price: 2, shelf_life: "1 month")
